...
const routes: Routes = [
  ...
  { path: 'GiveTraineeFeedback/:courseId', component: GivetraineefeedbackComponent },
  { path: 'ViewTraineeFeedback/:courseId/:traineeId', component: ViewtraineefeedbackComponent },
