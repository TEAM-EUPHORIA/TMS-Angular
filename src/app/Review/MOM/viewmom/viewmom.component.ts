...
export class ViewmomComponent implements OnInit {
  ...
  constructor(private reviewService: ReviewService, private route: Router, public ls: LoginService) { this.momId = this.route.getCurrentNavigation()?.extras.state?.['obj'] }
